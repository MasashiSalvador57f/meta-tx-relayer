...
const SimpleStorageABI = "[{\"inputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"constructor\",\"signature\":\"constructor\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":false,\"name\":\"sender\",\"type\":\"address\"},{\"indexed\":false,\"name\":\"x\",\"type\":\"uint256\"}],\"name\":\"Set\",\"type\":\"event\",\"signature\":\"0xfd28ec3ec2555238d8ad6f9faf3e4cd10e574ce7e7ef28b73caa53f9512f65b9\"},{\"constant\":false,\"inputs\":[{\"name\":\"x\",\"type\":\"uint256\"}],\"name\":\"set\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\",\"signature\":\"0x60fe47b1\"},{\"constant\":true,\"inputs\":[],\"name\":\"get\",\"outputs\":[{\"name\":\"\",\"type\":\"uint256\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\",\"signature\":\"0x6d4ce63c\"}]"
...
// SimpleStorageSetIterator is returned from FilterSet and is used to iterate over the raw logs and unpacked data for Set events raised by the SimpleStorage contract.
type SimpleStorageSetIterator struct {
	Event *SimpleStorageSet // Event containing the contract specifics and raw log
...
func (it *SimpleStorageSetIterator) Next() bool {
...
func (it *SimpleStorageSetIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *SimpleStorageSetIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// SimpleStorageSet represents a Set event raised by the SimpleStorage contract.
type SimpleStorageSet struct {
	Sender common.Address
	X      *big.Int
	Raw    types.Log // Blockchain specific contextual infos
}

// FilterSet is a free log retrieval operation binding the contract event 0xfd28ec3ec2555238d8ad6f9faf3e4cd10e574ce7e7ef28b73caa53f9512f65b9.
//
// Solidity: event Set(address sender, uint256 x)
func (_SimpleStorage *SimpleStorageFilterer) FilterSet(opts *bind.FilterOpts) (*SimpleStorageSetIterator, error) {

	logs, sub, err := _SimpleStorage.contract.FilterLogs(opts, "Set")
	if err != nil {
		return nil, err
	}
	return &SimpleStorageSetIterator{contract: _SimpleStorage.contract, event: "Set", logs: logs, sub: sub}, nil
}

// WatchSet is a free log subscription operation binding the contract event 0xfd28ec3ec2555238d8ad6f9faf3e4cd10e574ce7e7ef28b73caa53f9512f65b9.
//
// Solidity: event Set(address sender, uint256 x)
func (_SimpleStorage *SimpleStorageFilterer) WatchSet(opts *bind.WatchOpts, sink chan<- *SimpleStorageSet) (event.Subscription, error) {

	logs, sub, err := _SimpleStorage.contract.WatchLogs(opts, "Set")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(SimpleStorageSet)
				if err := _SimpleStorage.contract.UnpackLog(event, "Set", log); err != nil {
					return err
				}
				event.Raw = log
